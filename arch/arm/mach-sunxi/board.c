...
static int gpio_init(void)
{
	...
	sunxi_gpio_set_cfgpin(SUNXI_GPI(0), SUN50I_H616_GPI_UART2);
	sunxi_gpio_set_cfgpin(SUNXI_GPI(1), SUN50I_H616_GPI_UART2);
	sunxi_gpio_set_pull(SUNXI_GPI(1), SUNXI_GPIO_PULL_UP);
